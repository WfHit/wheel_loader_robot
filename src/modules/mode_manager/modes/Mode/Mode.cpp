...
bool Mode::activate(const trajectory_setpoint_s &last_setpoint)
{
	_resetSetpoints();
...
void Mode::initEkfResetCounters()
{
...
void Mode::_checkEkfResetCounters()
{
...
void Mode::_evaluateVehicleLocalPosition()
{
...
void Mode::_evaluateVehicleLocalPositionSetpoint()
{
...
void Mode::_evaluateDistanceToGround()
{
...
void Mode::_setDefaultConstraints()
{
